...
$sql = "SELECT * FROM patient_notes where patient_id = $pid";
...
<head>
    ...
    <title>Patient Progress Notes | Motion Sync EMR</title>
...
<body>
    <div class="container">
        ...
        <h2 class="intake-title">Physical Therapy Patient Progress Notes (<?php echo $patientData['title']. ' '. $patientData['fname'] .' '. $patientData['lname']  ?>)</h2>
