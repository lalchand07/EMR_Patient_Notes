...
if (isset($_GET['term']) &&  $_GET['term'] != "") {
    ...
    $sql = "SELECT * FROM patient_daily_notes where id = " . $_GET['term'] . "";
...
<body>
    ...
    <div class="container">
        <header>
            ...
            <h1 class="intake-title" class="text-center">PT Daily Treatment SOAP Note</h1>
        ...
        ?>
            ...
            <div class="card container-print" id="pdfSection">
                <div class="card-body p-5">
                    <h4 class="card-title">PT Daily Treatment SOAP Note (<?php echo $patientData['title'] . ' ' . $patientData['fname'] . ' ' . $patientData['lname'] ?>)</h4>
                    ...
                    <div class="row view-intake-forms-rows">
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <p><strong>Date of Treatment</strong></p>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6">
                            <p><?php echo (isset($row['treatment_date']) && $row['treatment_date'] != "") ? $row['treatment_date']  : "N/A"; ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <p><?php echo (isset($row['subjective']) && $row['subjective'] != "") ? $row['subjective']  : "N/A"; ?></p>
                        </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6">
                            <p><?php echo (isset($row['objective']) && $row['objective'] != "") ? $row['objective']  : "N/A"; ?></p>
                        </div>
